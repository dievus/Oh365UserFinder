...
### Acknowledgements
This project is loosely inspired by a tool named o365Creeper developed by Korey Mckinley that was developed in Python2. This started as a port over from Python2 to Python3 and spiraled into what it is now.
